...
public class DragDropSystem : FSystem
{
	...
	public void beginDragElementFromLibrary(BaseEventData element)
    {
		...
		if (!Pause && Global.GD.dragDropEnabled && (element as PointerEventData).button == PointerEventData.InputButton.Left && element.selectedObject != null)
		{
	...
	{
		if(!Pause && Global.GD.dragDropEnabled && itemDragged != null) {
	...
	public void deleteElement(GameObject elementToDelete)
	{
		...
		if(!Pause && Global.GD.dragDropEnabled && elementToDelete != null)
        {
